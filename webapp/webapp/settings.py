...
STATIC_ROOT = os.path.join(os.path.dirname(os.path.dirname(BASE_DIR)), 'webapp/static')

# do the same for media files, it must match 
MEDIA_ROOT = os.path.join(os.path.dirname(os.path.dirname(BASE_DIR)), 'webapp/media')
